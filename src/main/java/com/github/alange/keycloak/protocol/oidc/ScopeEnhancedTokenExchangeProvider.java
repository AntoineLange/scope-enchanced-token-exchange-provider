 ...
 */
public class ScopeEnhancedTokenExchangeProvider implements TokenExchangeProvider {

    private static final Logger logger = Logger.getLogger(ScopeEnhancedTokenExchangeProvider.class);
